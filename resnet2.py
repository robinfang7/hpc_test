...
def identity_building_block(input_tensor,
  ...
  x, marker_id, domain_id = NVTXStart(message='identity_building_block', 
                                      domain_name='forward', trainable=True)(x)
  ...
  x = NVTXEnd(grad_message='identity_building_block_grad',
...
def conv_building_block(input_tensor,
  ...
  x, marker_id, domain_id = NVTXStart(message='conv_building_block',
                                      domain_name='forward', trainable=True)(x)
  ...
  x = NVTXEnd(grad_message='conv_bhilding_block_grad',
              grad_domain_name='backwards')([x, marker_id, domain_id])
...
def resnet(num_blocks, img_input=None, classes=10, training=None):
  ...
  x, marker_id, domain_id = NVTXStart(message='resnet',
                                      domain_name='forward', trainable=True)(x)
  ...
  x = NVTXEnd(grad_message='resnet_grad',
              grad_domain_name='backwards')([x, marker_id, domain_id])
