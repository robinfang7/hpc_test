...
def main():
    ...
    #nvtx.range_push("Model_to_device")
    model.to(device)
    #nvtx.range_pop()
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        avg_period = (avg_period * (epoch - 1) + period) / epoch
    print("Average period of " + str(args.epochs)+ " epochs:", avg_period)
